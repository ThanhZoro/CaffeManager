...
public class PanelThongKe extends javax.swing.JPanel {
    ...
    private DefaultTableModel dtmBang = new DefaultTableModel();
    
    public PanelThongKe() {
        initComponents();
        dtmBang.addColumn("STT");
        dtmBang.addColumn("Tên món");
        dtmBang.addColumn("Số lượng đã bán");
        dtmBang.addColumn("Tổng");
        jTable.setModel(dtmBang);
